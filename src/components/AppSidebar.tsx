...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="transition-all duration-300 border-r border-border/30 bg-background/98 backdrop-blur-2xl shadow-2xl">
      <SidebarHeader className="p-6 border-b border-border/30 bg-gradient-to-br from-primary/8 via-primary/4 to-accent/8">
